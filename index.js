...
// const projectPageURL = `https://s7v--s7v--8bt6yczpn7jy.code.run`;
const uuid = (process.env.UUID || 'de04add9-5c68-6bab-950c-08cd5320df37').replace(/-/g, "");
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nz.sslav.us.kg:5555';
const NEZHA_KEY = process.env.NEZHA_KEY || 'L7QUr67Zj8Q9ROlFlq';
